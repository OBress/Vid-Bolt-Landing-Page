  ...
  return (
    ...
    >
      ...
      >
        ...
        <br />
        Production
        <span className="mobile-break" /> Platform.
      </h1>
    </section>
  );
}
...
const FEATURES = [
  ...
  },
  {
    ...
    bullets: [
      "Custom AI model & voice selection",
  ...
  },
  {
    ...
    bullets: [
      "One-click topic-to-video pipeline",
          ...
          return (
            <div
              ...
              style={{
                ...
                alignItems: "center",
                marginBottom:
                  i < FEATURES.length - 1 ? "clamp(80px, 12vw, 140px)" : "0",
              }}
            ...
            >
              ...
              <div
                ...
                className={`${reversed ? "reveal-right" : "reveal-left"} mobile-text-first`}
              >
                <div
                  style={{
                    display: "inline-flex",
              ...
              <div
                ...
                className="reveal-scale mobile-image-second"
              >
                <Image
                  src={f.image}
                  alt={f.alt}
...
const STEPS = [
  {
    icon: FileText,
    title: "Outline",
    desc: "Describe your idea and let AI handle the rest — it plans and structures your content automatically.",
  },
  {
    icon: Wand2,
    title: "Script",
    desc: "AI transforms your outline into a complete, production-ready script tailored to your vision.",
  },
  {
    icon: Cpu,
    title: "Production",
    desc: "All media assets are generated in parallel using high-performance cloud infrastructure.",
  },
  {
    icon: Film,
    title: "Editor",
    desc: "Review and refine your video with a built-in professional editing suite.",
  },
  {
    icon: Download,
    title: "Export",
    desc: "Render in high quality and publish or download — ready to share in one click.",
  },
];
...
function HowItWorks() {
  return (
    <section
      id="how-it-works"
      style={{ padding: "clamp(80px, 12vw, 160px) 0", position: "relative" }}
    >
      <div
        style={{
          position: "absolute",
      ...
      >
        ...
        >
          ...
          >
            Five steps.{" "}
            <span style={{ color: "#525252" }}>Zero complexity.</span>
          </h2>
        </div>
...
const TRUST = [
  {
    ...
    desc: "Powered by NVIDIA GPUs for blazing-fast media generation and video rendering.",
  },
  {
    icon: Bot,
    title: "Multi-Agent AI",
    desc: "Specialized AI agents for research, scripting, visuals, audio, editing, and assembly.",
  },
  {
    icon: Globe,
    title: "Cloud-Native",
    desc: "Access from any device, auto-save your work, and collaborate seamlessly.",
  },
  {
    icon: DollarSign,
    title: "Extreme Efficiency",
    desc: "Every 60 minutes of video costs roughly $10 — way below industry standard for AI-generated content.",
  },
];
      ...
      <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px" }}>
        ...
        >
          ...
          >
            ...
            <span style={{ color: "#525252" }}>Creator-friendly.</span>
          </h2>
        </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Vid Bolt is invite-only. We partner with experienced creators and
          established channels who are ready to scale production through AI.
        ...
        <p style={{ marginTop: "16px", fontSize: "12px", color: "#404040" }}>
          Invite-only · Business partnerships · Established channels welcome
        </p>
      </div>
    </section>
  );
      ...
      <div style={{ maxWidth: "1440px", margin: "0 auto", padding: "24px" }}>
        ...
        >
          <p style={{ fontSize: "12px", color: "#404040" }}>
            &copy; 2026 Vid Bolt. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
